function numToBeProcessed = extractNumFrom(filename)
% filename is the filename of the image
% numToBeProcessed is a 3D array (:,:,6), containing six numbers image
% 3rd dimension of numToBeProcessed = [upLeft, upRight, midLeft, midRight, 
% bottomLeft, bottomRight]

%% read in the file, convert to gray scale
imageColor = imread(filename);
